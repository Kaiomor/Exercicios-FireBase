package com.example.aula_01.firebase;
...
public class NovaMain3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nova_main3);
        ...
        artistsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(NovaMain3Activity.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
}